...
- Never give advice that contradicts the numbers in the data"""
        ...
        system_content = (
            ...
            "7. SCOPE RESTRICTION: You are a strictly financial AI. If the user asks off-topic questions (e.g., politics, geography, general trivia, coding) that are unrelated to their financial profile, credit score, or Tamweel policies, you MUST politely decline to answer. Set support_score to 1, and do NOT output a 'Trust & Transparency' section in the answer field.\n\n"
            ...
            "At the very end of EVERY response (EXCEPT when declining off-topic questions), you MUST include a footer section titled `### Trust & Transparency`. You must parse the `<backend_metadata>` to provide this section in a polished, live-demo-ready format. Do not invent metadata. Use exactly what the backend provided:\n"
