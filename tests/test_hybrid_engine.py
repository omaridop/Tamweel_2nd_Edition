...
def test_deterministic_score_calculation(mock_predict, mock_explanation):
    ...
    res1 = engine.run_pipeline({"requested_amount_jod": 2000, "avg_monthly_income_jod": 500})
    ...
    res2 = engine.run_pipeline({"requested_amount_jod": 2000, "avg_monthly_income_jod": 500})
    ...
    mock_predict.return_value = 85.0
    res3 = engine.run_pipeline({"late_bills_count": 5, "requested_amount_jod": 2000, "avg_monthly_income_jod": 500})
